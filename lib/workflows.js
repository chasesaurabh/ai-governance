...
export const workflows = {
  ...
  docs: ['Read the relevant behavior and existing documentation.', 'Write or update the requested documentation within scope.', 'Check factual accuracy, links and examples; do not claim unrun commands passed.'],
