...
export const actions = ['explain', 'review', 'security-review', 'feature', 'bugfix', 'refactor', 'new-project', 'deploy', 'incident', 'commit', 'clear-context', 'dependencies', 'architecture', 'clarify'];
